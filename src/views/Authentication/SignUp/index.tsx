...
export default function SignUp() {
  ...
  const emailCertificationResponse = (
    ...
    if (code === ResponseCode.MAIL_FAIL) alert("메일 전송에 실패하였습니다.");
    if (code === ResponseCode.DATABASE_ERROR) alert("데이터베이스 오류입니다.");
    if (code !== ResponseCode.SUCCESS) return;
  ...
  const onSignUpButtonClickHandler = () => {
    ...
    if(!checkedPassword) {
      ...
      setPasswordMessage("비밀번호는 영문, 숫자 조합 8~13자리입니다.");
      return;
    }
          ...
          <div className="sign-up-content-box">
            <div className="sign-up-content-sns-sign-in-box">
              ...
              <div className="sign-up-content-sns-sign-in-button-box">
                <div className="kakao-sign-in-button" onClick={() => onSnsSignInButtonClickHandler('kakao')}>
                  <button>카카오 로그인</button>
                </div>
                <div className="naver-sign-in-button" onClick={() => onSnsSignInButtonClickHandler('naver')}>
